...
<body>
  ...
  <tbody>
    <tr>
       <td width="140"><a href="http://www.scau.edu.cn"><img src="images/header-left.gif" alt="Java|Java世界_中文论坛|ChinaJavaWorld技术论坛" border="0"></a></td>
                      ...
                      <tr id="jive-message-780144" class="jive-odd" valign="top">
                            ...
                            <tbody>
                              <tr>
                                <td><table border="0" cellpadding="0" cellspacing="0" width="100%">
                                    <tbody>
                                      <tr valign="top">
                                        <td style="padding: 0px;" width="1%"><nobr> <a href="show.jsp?id=${article.authorid}" title="${article.authorName}">${article.authorName}</a> </nobr> </td>
                                  ...
                                  注册:
                                  07-5-10 <br>
                                  <a href="show.jsp?id=${article.authorid}" target="_blank"><font color="red">访问我的Blog</font></a> </span> </td>
                              </tr>
                            </tbody>
                          </table>
						  <!--个人信息table结束-->
                        ...
                        <td class="jive-last" width="99%"><table border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tbody>
                              <tr valign="top">
                                <td width="1%"></td>
                                <td width="97%"><span class="jive-subject"> ${sign} + "-------" + ${article.title }</span> </td>
                                ...
                                <td width="1%"><div class="jive-buttons">
                                    <table border="0" cellpadding="0" cellspacing="0">
                                      <tbody>
                                        <tr>
                                          <td>&nbsp;</td>
                                          <td class="jive-icon"><a href="reply.jsp?pid=${article.id}&rootid=${article.rootid}&replyName=${article.authorName}&floor=${sign}&authorid=${sessionScope.id}" title="回复本主题"><img src="images/reply-16x16.gif" alt="回复本主题" border="0" height="16" width="16"></a> </td>
                                          <td class="jive-icon-label"><a href="reply.jsp?pid=${article.id}&rootid=${article.rootid}&replyName=${article.authorName}&floor=${sign}&authorid=${sessionScope.id}" title="回复本主题">回复</a> </td>
                                        </tr>
                                      </tbody>
                                    </table>
                                  </div></td>
                              ...
                              <tr>
                                <td colspan="4" style="border-top: 1px solid rgb(204, 204, 204); font-size: 9pt; table-layout: fixed;"> ·<a href="http://www.scau.edu.cn"><font color="#666666">http://www.scau.edu.cn</font></a> </td>
                              </tr>
                            </tbody>
                          </table></td>
                      </tr>
